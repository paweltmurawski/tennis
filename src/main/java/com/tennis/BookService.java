...
public class BookService {
    ...
    private Set<Book> exampleData() {
        ...
        books.add(new Book("The Silent Patient", "Alex Michaelides", "2019", BookType.CLASSIC));
        books.add(new Book("The Handmaid's Tale", "Margaret Atwood", "2019", BookType.THRILLER));
